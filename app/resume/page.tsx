  ...
  return (
    <main className="original-resume-page">
      <header className="original-resume-header">
        <a href="/" aria-label="返回首页"><span aria-hidden="true">⌂</span>返回首页</a>
        <div>
      ...
      <div className="original-resume-content">
        <figure>
          <img src="/resume-page-01.png" alt="徐月月原简历第一页" loading="eager" />
          <figcaption>01 / 个人信息、个人优势与工作经历</figcaption>
        </figure>
        <figure>
          <img src="/resume-page-02.png" alt="徐月月原简历第二页" loading="lazy" />
